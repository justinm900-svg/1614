...
> **ACCOUNT-SIDE TASK.** Square is not reachable from the automation environment (checked twice on 2026-09-24 and once more in the later session; no further retries). Everything below is for Justin in a logged-in browser.
